...
public class KISA_SEED_CBC {
	...
	//암복호화 키는 추후 별도로 관리.
	public static final byte[] PBSZ_USER_KEY = "testCrypt2021!@#".getBytes(StandardCharsets.UTF_8);
	public static final byte[] PBSZ_IV = "1234567890123456".getBytes(StandardCharsets.UTF_8);
	...
	public static byte[]
	SEED_CBC_Decrypt( byte[] pbszUserKey, byte[] pbszIV, byte[] message, int message_offset, int message_length ) {
		KISA_SEED_INFO info = new KISA_SEED_INFO();
		int[] outbuf;
		int[] data;
		byte[] cdata;
